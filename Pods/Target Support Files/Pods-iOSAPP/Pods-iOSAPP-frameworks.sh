...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SHAVPlayer/SHAVPlayer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SHActionSheetView/SHActionSheetView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SHAlertView/SHAlertView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SHClickTextView/SHClickTextView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SHCollectionViewFlowLayout/SHCollectionViewFlowLayout.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SHEmptyView/SHEmptyView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SHPopView/SHPopView.framework"
